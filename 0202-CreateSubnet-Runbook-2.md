...
本手順では、ap-northeast-1aにPublic Subnetを作成する
...
```bash
RUNBOOK_TITLE="0202-create-subnet-2"
DIR_PARAMETER="."
...
VPC_SUBNET_CIDR="10.0.0.64/27"
VPC_SUBNET_AZ="ap-northeast-1a"
VPC_SUBNET_NAME="project-dev-pub1-subnet"
```
...
Next: [Subnetを作成する-3 Transit Subnet](./0203-CreateSubnet-Runbook-3.md)
