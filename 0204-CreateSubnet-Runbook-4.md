...
本手順では、ap-northeast-1cにPrivate Subnetを作成する
...
```bash
RUNBOOK_TITLE="0204-create-subnet-1"
DIR_PARAMETER="."
...
VPC_SUBNET_CIDR="10.0.0.128/26"
VPC_SUBNET_AZ="ap-northeast-1c"
VPC_SUBNET_NAME="project-dev-priv2-subnet"
```
...
Next: [Subnetを作成する-5 Transit Subnet](./205-CreateSubnet-Runbook-5.md)
